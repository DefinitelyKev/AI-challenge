...
export function buildTriageSystemPrompt(config: TriageConfig): string {
  ...
  - When you've identified the correct assignee, clearly state: "Please email ${
    rulesList.includes("@") ? "[assignee email]" : "the appropriate contact"
